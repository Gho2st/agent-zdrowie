...
df = pd.read_excel(plik_excel, sheet_name='Liczba odpowiedzi 1', usecols=[1, 18])  # 1 = Wiek, 18 = Czy płatna
...
print("Tabela 1. Skłonność do korzystania z wersji płatnej według grup wiekowych (N=123)")
print(contingency)
...
df = pd.read_excel(plik_excel, sheet_name='Liczba odpowiedzi 1', usecols=[2, 18])  # 2 = Stan zdrowia, 18 = Czy płatna
