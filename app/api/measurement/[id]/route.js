...
export async function DELETE(req, { params }) {
  ...
  try {
    ...
    if (measurementToDelete.type === MeasurementType.WEIGHT) {
      // Znajdź najnowszy pozostały pomiar wagi
      ...
      if (latestRemainingWeight.length > 0) {
        //  Jeśli znaleziono, użyj jego wartości
        newWeightValue = latestRemainingWeight[0].value;
      }

      //  Zaktualizuj HealthProfile użytkownika
